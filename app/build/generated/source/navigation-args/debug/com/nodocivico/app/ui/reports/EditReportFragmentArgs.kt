...
public data class EditReportFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EditReportFragmentArgs {
      bundle.setClassLoader(EditReportFragmentArgs::class.java.classLoader)
      val __reportId : Long
      ...
      return EditReportFragmentArgs(__reportId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): EditReportFragmentArgs {
      val __reportId : Long?
